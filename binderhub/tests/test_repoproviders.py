...
from binderhub.repoproviders import DataverseProvider
from binderhub.repoproviders import FigshareProvider
from binderhub.repoproviders import GistRepoProvider
from binderhub.repoproviders import GitHubRepoProvider
from binderhub.repoproviders import GitLabRepoProvider
from binderhub.repoproviders import GitRepoProvider
from binderhub.repoproviders import HydroshareProvider
from binderhub.repoproviders import strip_suffix
from binderhub.repoproviders import tokenize_spec
from binderhub.repoproviders import ZenodoProvider
...
def test_custom_config():
    ...
    base_config_second = {"pattern": "^jupyterh.*", "config": {"key1": "newvalue",}}
    provider = GitHubRepoProvider(
        spec="jupyterhub/zero-to-jupyterhub-k8s/v0.4",
...
class TestSpecErrorHandling(TestCase):
    ...
    def test_spec_with_no_suggestion(self):
        spec = "short/master"
        error = r"^((?!Did you mean).)*$"  # negative match
